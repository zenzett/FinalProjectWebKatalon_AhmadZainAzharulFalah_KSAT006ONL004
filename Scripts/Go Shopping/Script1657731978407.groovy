...
WebUI.click(findTestObject('Page_My Account Kotakoki/a_Shop'))
...
WebUI.click(findTestObject('Object Repository/Page_Beanie with Logo  Kotakoki/button_Add to cart'))

WebUI.click(findTestObject('Object Repository/Page_Cart  Kotakoki/a_1'))
